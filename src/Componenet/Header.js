...
const Header = () => {
    ...
    return (
        ...
        <>
            <Navbar className='topp' style={{ height: "60px" }}>
                <Container>

                    <NavLink to="/" className="text-decoration-none text-light mx-3"  >  <img style={{ height: 50, paddingRight: "5rem" }} src='https://raw.githubusercontent.com/Ramanpreet6262/Dominos-Menu-Clone/master/dominos-menu-clone/src/static/assets/logo_white.svg' /></NavLink>
                    ...
                    <Badge badgeContent={getdata.length} color="primary"
                        ...
                        onClick={handleClick}
                    >
                        <AddShoppingCartIcon color='dark' style={{ fontSize: '25', cursor: "pointer" }} />
                    </Badge>
